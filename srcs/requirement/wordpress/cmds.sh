...
# from the default /run/php/php8.2-fpm.sock to TCP/IP port 9000 .
...
wp core install --url=$WP_URL --title="My Wordpress Site" --admin_user=$WP_ADMIN_USER --admin_password=$ADMIN_WP_ADMIN_PASSWORD --admin_email=$WP_ADMIN_EMAIL --allow-root

# create second user in wordpress
wp user create 'test' 'test@gmail.com' --user_pass='test' --role='author' --allow-root
